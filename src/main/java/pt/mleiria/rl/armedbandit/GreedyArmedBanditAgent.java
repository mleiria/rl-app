 ...
 */
class GreedyArmedBanditAgent implements ArmedBanditAgent {
     ...
     */
    public GreedyArmedBanditAgent(int numArms) {
     ...
     */
    public GreedyArmedBanditAgent(int numArms, final double optimisticInitialValue) {
